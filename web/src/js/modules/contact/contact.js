...
===========================================================\n\n
Informações úteis para nós: versão ${global.version} - ${btoa(state.toJSON())}\n
===========================================================\n\n`;

   window.location.href = "mailto:apoiobcc@linux.ime.usp.br?subject=D%C3%BAvida/Sugest%C3%A3o%20MatrUSP&body=" + encodeURI(msg); 

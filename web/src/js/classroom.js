 ...
 */
export default function Classroom(jsonObj, parentLecture) {
  ...
  if (jsonObj) {
    ...
    for(var vacancyType in jsonObj.vagas) {
      ...
      for(var vacancyGroup in jsonObj.vagas[vacancyType].grupos) {
        var group = jsonObj.vagas[vacancyType].grupos[vacancyGroup];

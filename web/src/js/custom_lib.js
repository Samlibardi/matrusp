 ...
 */
export function createAndAppendChild(parent, tag, attributes) {
 ...
 */
export function createHtmlElementTree(rootObj) {
  if (!rootObj.tag) {
 ...
 * @return {Number}
 */
export function indexOfDay(day) {
  switch (day) {
    case 'seg': return 0;
    case 'ter': return 1;
    case 'qua': return 2;
 ...
 */
export function classroomsConflict(classroom1, classroom2) {
